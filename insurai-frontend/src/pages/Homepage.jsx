...
const Homepage = () => {
  ...
  primaryDark: '#35405dff',    // Almost black (nav/footer)
  primaryLight: '#3b82f6',   // Soft professional blue
  secondary: '#2563eb',      // Accent blue
  accent: '#60a5fa',         // Light blue highlight

  success: '#1e40af',
  warning: '#b45309',

  light: '#fafaf9',          // Cream-white background
  white: '#ffffff',
  dark: '#0f172a',           // Professional black
  gray: '#475569',           // Neutral gray

  gradientHero: 'linear-gradient(135deg, #0f172a 0%, #1e3a8a 100%)',
  gradientNav: 'linear-gradient(90deg, #0f172a 0%, #1e293b 100%)',
  gradientCard: 'linear-gradient(135deg, #ffffff 0%, #f8fafc 100%)',
  gradientAccent: 'linear-gradient(135deg, #2563eb 0%, #60a5fa 100%)'
};
  ...
  const features = [
  {
    ...
    gradient: 'linear-gradient(135deg, #1e3a8a 0%, #2e3b58ff 100%)',
    stats: '90% Faster'
  },
  {
    icon: '🧠',
  ...
  },
  {
    ...
    gradient: 'linear-gradient(135deg, #1e40af 0%, #33537aff 100%)',
    stats: '100% Visible'
  },
  {
    icon: '🛡️',
    ...
    gradient: 'linear-gradient(135deg, #242c51ff 0%, #1e3a8a 100%)',
    stats: '99% Accurate'
  },
  {
    icon: '📊',
    ...
    gradient: 'linear-gradient(135deg, #293343ff 0%, #3b82f6 100%)',
  ...
  },
  {
    ...
    gradient: 'linear-gradient(135deg, #2570bbff 0%, #3e4f67ff 100%)',
    stats: 'Flexible'
  }
];
    ...
    <div className="row align-items-center min-vh-100">
      ...
      <div className="col-lg-6" style={{
        ...
        <h1 className="display-4 fw-bold mb-4" style={{
          ...
          Enterprise Insurance Management for Corporates
        </h1>
...
>
  ...
  >
    <img
      src="/Photo1.png"   // 🔹 replace with your image path
      alt="InsurAI Platform Overview"
      style={{
        width: '100%',
        height: 'auto',
        borderRadius: '16px',
  ...
  <div className="container-fluid px-4">
    <div className="row align-items-center g-5">
      ...
      <div className="col-lg-6">
        <div
          style={{
            transform: isVisible.whyChoose ? 'translateX(0)' : 'translateX(-40px)',
      ...
      <div className="col-lg-6">
        <div className="mb-4">
          <h2 className="fw-bold display-6" style={{ color: colors.primary }}>
            Why Choose InsurAI
          </h2>
          <p className="text-muted mt-2">
            Designed to modernize insurance operations with automation, intelligence, and transparency.
          </p>
        </div>
        ...
        <div className="d-flex flex-column gap-4">
          {[
            ...
            },
            {
              ...
              description: 'Real-time claim tracking with full visibility for employees and HR.'
            },
            {
              title: 'AI Intelligence',
              description: 'Early fraud detection and predictive insights using machine learning.'
            },
            {
              title: 'Scalable & Secure',
              description: 'Enterprise-grade architecture built for organizations of any size.'
            },
            {
              title: 'Data-Driven Decisions',
              description: 'Advanced dashboards and reports for strategic decision-making.'
            },
            {
              title: '24/7 Support',
              description: 'Always-on technical and customer support for uninterrupted operations.'
            }
          ].map((item, index) => (
            <div
              key={index}
              style={{
                ...
                transform: isVisible.whyChoose ? 'translateY(0)' : 'translateY(20px)',
                opacity: isVisible.whyChoose ? 1 : 0,
            ...
            >
              ...
              {/* Text */}
              <div>
                <h6 className="fw-semibold mb-1" style={{ color: colors.dark }}>
                  {item.title}
                </h6>
  ...
  <div className="container-fluid px-4">
    <div className="text-center mb-5">
      ...
      <p className="text-muted">
        End-to-end automated claim processing workflow
      </p>
    </div>
    ...
    <div className="row justify-content-center position-relative">
      ...
      {/* Dotted Line */}
      <div
        className={`workflow-line ${isVisible.workflow ? "active" : ""}`}
      >
        <div className="workflow-arrow"></div>
      </div>

      {[
        { step: '01', title: 'Claim Submission', desc: 'Employees submit claims digitally' },
        { step: '02', title: 'AI Verification', desc: 'Automated eligibility & policy checks' },
        { step: '03', title: 'HR Review', desc: 'HR approves through dashboard' },
        { step: '04', title: 'Notifications', desc: 'Real-time claim updates' },
        { step: '05', title: 'Completion', desc: 'Fast, paperless settlement' }
      ].map((item, index) => (
